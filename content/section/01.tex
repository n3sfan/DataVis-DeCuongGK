\section{Tên đề tài}
\textbf{Phân tích động lực thị trường và giá/thanh lý của ETH, meme coin (DOGE) trong giai đoạn quý 1 2024 (tháng 1/2024 - 3/2024)}

\section{Danh sách thành viên}
Được ghi ở trang bìa.

\section{Mô tả dữ liệu}
Dữ liệu được thu thập từ sàn giao dịch lớn là và Binance \cite{binancevision_futures_data}, tập trung vào đồng Ethereum (ETH) trong các tháng 1 - 3/2024. Dữ liệu bao gồm ba nhóm chính, được mô tả chi tiết dưới đây.
...
\end{tabular}
\caption{Mô tả các trường dữ liệu Binance Kline (Coin-Margined)}
\end{table}
...
sum\_open\_interest\_value & Float & Tổng giá trị của hợp đồng mở quy đổi ra USD. \\ \hline
...
\begin{itemize}
    ...
    \item \textbf{Câu hỏi 4:} Khối lượng thanh lý, hợp đồng mở theo thời gian như thế nào trong một "ngày sập giá"? Xây dựng biểu đồ Heatmap để theo dõi vùng giá tập trung khối lượng thanh lý?
